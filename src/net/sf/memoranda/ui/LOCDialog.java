  ...
  */
	...
	*/
    ...
    private void txtProjActionPerformed(ActionEvent evt) {                                            
        // Implemented when panel is available
    }                                           
    ...
    private void okBActionPerformed(ActionEvent ev){
    	if(txtProj.getText().isEmpty() || txtLOC.getText().isEmpty()){
    		JOptionPane.showMessageDialog(null,"Error: Please enter a Project and the lines of code.",
