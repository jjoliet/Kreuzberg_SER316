...
public class TaskDialog extends JDialog implements WindowListener{
	...
	JComboBox phaseCB = new JComboBox();
	...
	void jbInit() throws Exception {
		...
		phaseCB.setModel(new DefaultComboBoxModel(new String[] {"None", "Planning", "Design", "Coding", "Code Review", "Compile", "Test", "Postmortem"}));

		categoryPanel.add(phaseCB);
